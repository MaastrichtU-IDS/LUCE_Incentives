...
tmux send-keys -t jupyter_ganache_django.1 'ganache-cli --mnemonic luce --db ~/.ganache_db --networkId 72 --host 0.0.0.0 --accounts 1000 --gasLimit 1000000000 --gasPrice 72000000000 --defaultBalanceEther 1000000' ENTER
